...
3. **Delegate the actual implementation to Cursor now, as your very next
   ...
   engine and a hand-copied one goes stale (this copy said
   `supabase/migrations/**` where the live list said `supabase/**`, and
   omitted `.github/**` and `.gitignore` entirely until 2026-08-29).
   Capture Cursor's full JSON result once the
